                        ...
                        <div className="row text-center text-xs-center text-sm-left text-md-left">
                            ...
                            <div className="col-xs-12 col-sm-4 col-md-4">
                                ...
                                <ul className="list-unstyled quick-links">
                                    ...
                                    <li><a href="test"><i className="fa fa-angle-double-right"></i>+355 69 000 0000</a></li>
                                    <li><a href="test"><i className="fa fa-angle-double-right"></i>+355 68 111 0000</a></li>
                            ...
                            <div className="col-xs-12 col-sm-4 col-md-4">
                                <h5>Partneret</h5>
                                <ul className="list-unstyled quick-links">
                                    <li><a href="test"><i className="fa fa-angle-double-right"></i>Alb - Trans sh.p.k</a></li>
                                    <li><a href="test"><i className="fa fa-angle-double-right"></i>AlbaTrans</a></li>
                                    <li><a href="test"><i className="fa fa-angle-double-right"></i>Tirana Metropol</a></li>
